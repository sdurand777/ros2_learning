...
static const _SetCommand_Request_type_support_symbol_names_t _SetCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_learning_msg, srv, SetCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_learning_msg, srv, SetCommand_Request)),
  }
};
...
{
  return &::ros2_learning_msg::srv::rosidl_typesupport_cpp::SetCommand_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_learning_msg, srv, SetCommand_Request)() {
  return get_message_type_support_handle<ros2_learning_msg::srv::SetCommand_Request>();
}
...
static const _SetCommand_Response_type_support_symbol_names_t _SetCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_learning_msg, srv, SetCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_learning_msg, srv, SetCommand_Response)),
  }
};
...
{
  return &::ros2_learning_msg::srv::rosidl_typesupport_cpp::SetCommand_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_learning_msg, srv, SetCommand_Response)() {
  return get_message_type_support_handle<ros2_learning_msg::srv::SetCommand_Response>();
}
...
static const _SetCommand_type_support_symbol_names_t _SetCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_learning_msg, srv, SetCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_learning_msg, srv, SetCommand)),
  }
};
...
{
  return &::ros2_learning_msg::srv::rosidl_typesupport_cpp::SetCommand_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_learning_msg, srv, SetCommand)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ros2_learning_msg::srv::SetCommand>();
}
