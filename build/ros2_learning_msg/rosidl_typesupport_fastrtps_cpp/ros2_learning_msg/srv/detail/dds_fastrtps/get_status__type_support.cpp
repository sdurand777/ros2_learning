...
#include "ros2_learning_msg/srv/detail/get_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_learning_msg::srv::GetStatus_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_learning_msg::srv::GetStatus_Request & ros_message)
{
  // Member: robot_name
  cdr >> ros_message.robot_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_learning_msg::srv::GetStatus_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_learning_msg::srv::GetStatus_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_learning_msg::srv::GetStatus_Request *>(
    untyped_ros_message);
...
{
  return &ros2_learning_msg::srv::typesupport_fastrtps_cpp::_GetStatus_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_learning_msg, srv, GetStatus_Request)() {
  return &ros2_learning_msg::srv::typesupport_fastrtps_cpp::_GetStatus_Request__handle;
}
...
{
bool cdr_serialize(
  const ros2_learning_msg::msg::RobotStatus &,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_learning_msg
cdr_serialize(
  const ros2_learning_msg::srv::GetStatus_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
  ...
  // Member: status
  ros2_learning_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.status,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_learning_msg::srv::GetStatus_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  // Member: status
  ros2_learning_msg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ros2_learning_msg::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_learning_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_RobotStatus(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_learning_msg::srv::GetStatus_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_learning_msg::srv::GetStatus_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_learning_msg::srv::GetStatus_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_learning_msg::srv::typesupport_fastrtps_cpp::_GetStatus_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_learning_msg, srv, GetStatus_Response)() {
  return &ros2_learning_msg::srv::typesupport_fastrtps_cpp::_GetStatus_Response__handle;
}
...
{
  return &ros2_learning_msg::srv::typesupport_fastrtps_cpp::_GetStatus__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_learning_msg, srv, GetStatus)() {
  return &ros2_learning_msg::srv::typesupport_fastrtps_cpp::_GetStatus__handle;
}
