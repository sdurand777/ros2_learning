...
#include "ros2_learning_msg/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_learning_msg::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_learning_msg::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_learning_msg::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &ros2_learning_msg::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
