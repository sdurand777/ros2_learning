...
#include "ros2_learning_msg/msg/detail/robot_status__rosidl_typesupport_fastrtps_c.h"
...
using _RobotStatus__ros_msg_type = ros2_learning_msg__msg__RobotStatus;
...
static uint32_t _RobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_learning_msg__msg__RobotStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_learning_msg__msg__RobotStatus;
    is_plain =
      (
...
static size_t _RobotStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_learning_msg__msg__RobotStatus(
