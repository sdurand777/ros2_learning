...
#include "ros2_learning_msg/msg/detail/sensor_data__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acceleration, gyroscope, magnetometer
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ros2_learning_msg
...
using _SensorData__ros_msg_type = ros2_learning_msg__msg__SensorData;
...
static uint32_t _SensorData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_learning_msg__msg__SensorData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_learning_msg__msg__SensorData;
    is_plain =
      (
...
static size_t _SensorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_learning_msg__msg__SensorData(
