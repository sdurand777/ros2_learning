...
static const _SetCommand_Request_type_support_symbol_names_t _SetCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_learning_msg, srv, SetCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_learning_msg, srv, SetCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_learning_msg, srv, SetCommand_Request)() {
  return &::ros2_learning_msg::srv::rosidl_typesupport_c::SetCommand_Request_message_type_support_handle;
}
...
static const _SetCommand_Response_type_support_symbol_names_t _SetCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_learning_msg, srv, SetCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_learning_msg, srv, SetCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_learning_msg, srv, SetCommand_Response)() {
  return &::ros2_learning_msg::srv::rosidl_typesupport_c::SetCommand_Response_message_type_support_handle;
}
...
static const _SetCommand_type_support_symbol_names_t _SetCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_learning_msg, srv, SetCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_learning_msg, srv, SetCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros2_learning_msg, srv, SetCommand)() {
  return &::ros2_learning_msg::srv::rosidl_typesupport_c::SetCommand_service_type_support_handle;
}
