...
bool ros2_learning_msg__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_learning_msg.msg._robot_status.RobotStatus", full_classname_dest, 47) == 0);
  }
  ros2_learning_msg__msg__RobotStatus * ros_message = _ros_message;
  {  // header
...
PyObject * ros2_learning_msg__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_learning_msg.msg._robot_status");
